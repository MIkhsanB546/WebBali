...
<section class="mt-24">
  <div class="max-w-3/4 mx-auto">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
      <form action="mailto:mikhsanb546+webbali@gmail.com" method="post" enctype="text/plain" class="p-4 bg-gray-100 rounded-lg">
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="mail" name="mail" placeholder="example@mail.com"
            class="block p-1 w-full border-2 border-gray-400 rounded focus:border-green-500" required>
        </div>
        <div class="mb-4">
        ...
        <input type="submit" value="Send" class="py-2 px-4 bg-green-500 font-semibold text-white rounded cursor-pointer hover:bg-green-600">
